...
EMAIL_ORDER_FULFILLMENT_CONFIRMATION_ENABLED = get_bool_from_env('EMAIL_ORDER_FULFILLMENT_CONFIRMATION_ENABLED', True)
EMAIL_ORDER_FULFILLMENT_UPDATE_ENABLED = get_bool_from_env('EMAIL_ORDER_FULFILLMENT_UPDATE_ENABLED', False)
EMAIL_ORDER_CONFIRMATION_ENABLED = get_bool_from_env('EMAIL_ORDER_CONFIRMATION_ENABLED', True)
EMAIL_ORDER_STAFF_CONFIRMATION_ENABLED = get_bool_from_env('EMAIL_ORDER_STAFF_CONFIRMATION_ENABLED', True)
EMAIL_ORDER_PREPARING_ENABLED = get_bool_from_env('EMAIL_ORDER_PREPARING_ENABLED', True)
EMAIL_ORDER_CANCELED_ENABLED = get_bool_from_env('EMAIL_ORDER_CANCELED_ENABLED', True)
EMAIL_ORDER_PAYMENT_CONFIRMATION_ENABLED = get_bool_from_env('EMAIL_ORDER_PAYMENT_CONFIRMATION_ENABLED', False)
EMAIL_ORDER_PAYMENT_REFUNDED_ENABLED = get_bool_from_env('EMAIL_ORDER_PAYMENT_REFUNDED_ENABLED', False)

EMAIL_ORDER_STAFF_NOTIFICATION_GROUP_IDS = get_list(os.environ.get("EMAIL_ORDER_STAFF_NOTIFICATION_GROUP_IDS", ""))
